...
# Windows CMD
set GROQ_API_KEY=your_actual_groq_key_here
...
* Use Groq's LLM to classify affiliations

* Output results to a CSV file

* Show debug logs from Groq responses

----------------------------------------------------
### 🛠️ Steps followed to create the Project
